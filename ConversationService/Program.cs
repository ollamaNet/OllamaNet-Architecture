...
var documentStoragePath = builder.Configuration["DocumentManagement:StoragePath"] ?? "uploads/documents";
Directory.CreateDirectory(Path.Combine(app.Environment.ContentRootPath, documentStoragePath));
