...
namespace AdminService.Infrastructure.Caching
{
    ...
    public interface ICacheManager
    {
        ...
        /// <param name="dataProvider">Function to get the data if not in cache</param>
        /// <param name="expiration">Optional expiration timespan</param>
        /// <returns>The cached value or the result of the dataProvider</returns>
    ...
    public class CacheManager : ICacheManager
    {
        ...
        {
            _logger.LogWarning("Clear cache operation not implemented in AdminService");
